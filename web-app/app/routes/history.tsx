    ...
    <main>
      ...
      <body>
        ...
        <div className="overflow-x-auto">
          <div className="min-w-screen flex min-h-screen items-center justify-center overflow-hidden bg-gray-100 bg-gray-100 font-sans">
                ...
                <table className="w-full min-w-max table-auto">
                  ...
                  <tbody className="text-sm font-light text-gray-600">
                    <tr className="border-b border-gray-200 hover:bg-gray-100">
                      ...
                      <td className="px-6 py-3 text-center">
                        <div className="flex items-center justify-center">
                          <img
                            className="h-6 w-6 transform rounded-full border border-gray-200 hover:scale-125"
                            src="https://randomuser.me/api/portraits/men/1.jpg"
                          />
                          <img
                            className="-m-1 h-6 w-6 transform rounded-full border border-gray-200 hover:scale-125"
                    ...
                    <tr className="border-b border-gray-200 hover:bg-gray-100">
                      ...
                      <td className="px-6 py-3 text-center">
                        <span className="rounded-full bg-yellow-200 px-3 py-1 text-xs text-yellow-600">
                          Scheduled
                        </span>
                      </td>
                      <td className="px-6 py-3 text-center">
