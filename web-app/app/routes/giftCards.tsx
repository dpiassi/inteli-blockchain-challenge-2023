    ...
    <main>
      ...
      <body>
              ...
              <div className="flex-1 px-2 sm:px-0">
                ...
                <div className="mb-10 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div className="relative group bg-blue-500 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-blue-600/80 hover:smooth-hover">
                    ...
                    <button onClick={openModal1} className="group relative h-12 w-48 overflow-hidden rounded-lg bg-white text-lg shadow">
                  ...
                  <div className="relative group bg-blue-500 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-blue-600/80 hover:smooth-hover">
                    ...
                    <button onClick={openModal2} className="group relative h-12 w-48 overflow-hidden rounded-lg bg-white text-lg shadow">
                      <div className="absolute inset-0 w-3 bg-blue-800 transition-all duration-[250ms] ease-out group-hover:w-full"></div>
                      <span className="relative text-black group-hover:text-white">Purchase</span>
                    </button>
                  </div>
          ...
          <div className="flex min-h-screen items-center justify-start bg-white">
            <div className="mx-auto w-full max-w-lg">
              ...
              <form onSubmit={handleSubmit} id="purchase" className="mt-10">
                ...
                <button type="button" className="mt-5 rounded-md bg-black px-10 py-2 text-white" onClick={closeModal1}>Cancel</button>
              </form>
            </div>
          </div>
        </Modal>
        ...
        >
          <div className="flex min-h-screen items-center justify-start bg-white">
            <div className="mx-auto w-full max-w-lg">
              <h1 className="text-4xl font-medium">Modal2</h1>
              ...
              <form onSubmit={handleSubmit} id="purchase" className="mt-10">
                ...
                <button type="submit" className="mt-5 rounded-md bg-black px-10 py-2 text-white">Purchase</button>
                <button type="button" className="mt-5 rounded-md bg-black px-10 py-2 text-white" onClick={closeModal2}>Cancel</button>
              </form>
            </div>
          </div>
        </Modal>
